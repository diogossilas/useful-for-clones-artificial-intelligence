...
```mermaid
gantt
    title O Padrão Carson (1975 - 2026)
    dateFormat  YYYY
    axisFormat %Y
    
    section Vetores de Formação
    Sociologia (Graduação)        :done, 1973, 1977
    Surfe Profissional (Top 10)   :active, 1978, 1989
    
    section Vetores de Impacto (Editorial)
    Transworld Skateboarding      :done, 1983, 1987
    Beach Culture                 :done, 1989, 1991
    Ray Gun Magazine              :crit, 1992, 1996
    
    section Expansão (Estúdio/Global)
    David Carson Design           :active, 1995, 2026
    The End of Print (Best-seller):done, 1995, 1998
    Medalha AIGA                  :milestone, 2014, 2014
    Exposição Varsóvia (Colagem)  :milestone, 2026, 2026
```
